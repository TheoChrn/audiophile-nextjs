    ...
    <section className="flex flex-col gap-small">
      <article className="grid items-center overflow-hidden rounded bg-accent px-10  py-[5.5rem] text-center lg:grid-cols-2 lg:text-start">
        <div className="relative m-auto flex size-full items-center justify-center lg:translate-y-28 ">
          <figure className="relative z-10 h-[207px] w-[172.5px] bg-[url('/assets/home/mobile/image-speaker-zx9.png')] bg-contain bg-no-repeat md:h-[237px]  md:w-[197.21px]  md:bg-[url('/assets/home/tablet/image-speaker-zx9.png')]  lg:h-[493px] lg:w-[410.23px] lg:bg-[url('/assets/home/desktop/image-speaker-zx9.png')] animate-grow delay-75"></figure>
          <div className="absolute  left-1/2 top-1/2 aspect-square -translate-x-1/2 -translate-y-1/2 animate-beatsm rounded-full border-4 border-white/15"></div>
          <div className="absolute  left-1/2 top-1/2 aspect-square -translate-x-1/2 -translate-y-1/2 animate-beat rounded-full border-4 border-white/15 delay-200"></div>
          <div className="absolute  left-1/2 top-1/2 aspect-square -translate-x-1/2 -translate-y-1/2 animate-beatlg rounded-full border-4 border-white/15 delay-400 "></div>
        </div>
